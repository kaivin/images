...
1. 新建项目：
![](https://cdn.jsdelivr.net/gh/kaivin/images/article/images/readme/1.png)

2. 创建图片仓库：
![](https://cdn.jsdelivr.net/gh/kaivin/images/article/images/readme/2.png)

# 配置token key
生成一个`token`用于操作`github`项目。

1. 到设置页面：
![](https://cdn.jsdelivr.net/gh/kaivin/images/article/images/readme/3.png)

2. 进入页面后，点击`developer settings`按钮：
![](https://cdn.jsdelivr.net/gh/kaivin/images/article/images/readme/4.png)

3. 点击`personal access tokens`按钮，然后点击`Generate token`:
![](https://cdn.jsdelivr.net/gh/kaivin/images/article/images/readme/5.png)

![](https://cdn.jsdelivr.net/gh/kaivin/images/article/images/readme/6.png)

4. 填写描述，选择`repo`权限，然后拉到下面点击`Generate token`按钮（**注意：创建成功后，会生成一串token，这串token之后不会再显示，需要显示后自己保存下来，接下来会用到**）：
![](https://cdn.jsdelivr.net/gh/kaivin/images/article/images/readme/7.png)

![](https://cdn.jsdelivr.net/gh/kaivin/images/article/images/readme/8.png)
...
![](https://cdn.jsdelivr.net/gh/kaivin/images/article/images/readme/9.png)
...
![](https://cdn.jsdelivr.net/gh/kaivin/images/article/images/readme/10.png)

上传成功的图片可以在相册中看到：
![](https://cdn.jsdelivr.net/gh/kaivin/images/article/images/readme/11.png)
...
# jsdelivr配置说明
使用`jsdelivr`的免费`CDN`，不是需要通过`picgo`进行配置，`jsdelivr`与`github`可以直接进行联通，只需要通过固定的链式：`https://cdn.jsdelivr.net/gh/`，这个是`jsdelivr`访问`github`的固定链式，`gh`是`github`的缩写，后面的部分就是用户名以及具体项目，最后是项目内某张图片的具体路径。
